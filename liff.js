window.onload = function() {
    ...
    const defaultLiffId = "1655312526-OaNEKLrN";   // change the default LIFF value if you are not using a node server
...
function profile() {
    ...
    console.log(profile.pictureUrl) //print url gambar profil user
  })
  .catch(error => {
...
function registerButtonHandlers() {
    document.getElementById('openWindowButton').addEventListener('click', function() {
        liff.openWindow({
            url: 'https://websitelineliff.herokuapp.com/', // Isi dengan Endpoint URL aplikasi web Anda
            external: true
        });
    });
